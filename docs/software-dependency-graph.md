...
the C++ engine and `wasm/` SDK. OSFS installs the clean in-tree `1.2.4-fork.5`
...
flowchart TB
  ...
  JSW["@felipegalind0/jsbsim<br/>1.2.4-fork.5 tarball under deps/<br/>SDK: MIT"]
...
`package.json` declares `file:deps/felipegalind0-jsbsim-1.2.4-fork.5.tgz`
