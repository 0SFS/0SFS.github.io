...
The family UI is implemented; [the subsequent qualification record](sf50-calibration-qualification-2026-09-12.md) reviews all 41 existing windows and 27 selected ISA AFM rows. Three windows contain recorded input/mode changes; all 41 remain blocked for calibration. Selected numeric AFM transcription matches, but conditions, temperature conventions and cumulative-fuel interpretation retain explicit blockers. The new ledgers preserve source identities, missing uncertainty and whole-flight/condition allocation.

The [Cirrus 31452-111 listing](https://store.cirrusaircraft.com/sf50-supplement-31452-111%2C-updated-thrust-schedule/5637446851.p) supplies a specific applicability question: data-plate configuration 26000-004 or SB5X-72-01 compliance. The [publication-suite description](https://store.cirrusaircraft.com/sf50-vision-jet-online-technical-publications-suite/5637407076.p) confirms that some documents are accessible to registered accounts, without establishing access for the exact needed documents. A later-AFM public text mirror is an acquisition lead only. Applicable primary pages and donor retrofit/loading metadata remain unresolved.

The pinned FlightData snapshot establishes OAT Celsius, but its fuel caption says only `gal/Hr`; the normalizer now preserves the unresolved flow as raw. The older processed outputs are unchanged and must not be interpreted as newly qualified US-gph data. Public documentation did not establish anonymous original CSV export or downstream reuse permission for the flight. No account, purchase, contact or restricted endpoint access occurred. No processing rerun, test or simulation ran.
