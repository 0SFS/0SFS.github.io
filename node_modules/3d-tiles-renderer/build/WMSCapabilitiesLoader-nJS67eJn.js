...
class gt extends Tn {
  ...
  async parseToMesh(e, t, ...s) {
    ...
    if (i === "ellipsoid") {
      const c = o.ellipsoid, u = t[le], h = t[Te], d = t[be], [f, m, p, y] = t.boundingVolume.region, g = Math.ceil((y - m) * M.RAD2DEG * 0.25), x = Math.ceil((p - f) * M.RAD2DEG * 0.25), b = Math.max(wi, g), T = Math.max(Ei, x), _ = new rn(1, 1, T, b), [S, C, A, P] = l.getTileBounds(h, d, u, !0, !0), R = l.getTileContentUVBounds(h, d, u), { position: V, normal: k, uv: W } = _.attributes, Q = V.count;
...
class Hi {
  ...
  parseToMesh(e, t, s, n) {
    ...
    return t.boundingVolume.region[4] = d, t.boundingVolume.region[5] = f, t.engineData.boundingVolume.setRegionData(u, ...t.boundingVolume.region), m && ("geometricerror" in m && (t.geometricError = m.geometricerror), At(t, this.layer) && "available" in m && t.children.length === 0 && (t[ge] = [
  ...
  getFeatures(e, t) {
    ...
    for (let d = 0, f = i.length; d < f; d++) {
      ...
      if ("texture" in m) {
        ...
        En(s, m.texture.texCoord, t, l, Es), wn(Es, y.image.width, y.image.height, ws), Ps.set(d, 0), de.renderPixelToTarget(n[m.texture.index], ws, Ps);
  ...
  update() {
    ...
    const u = (f, m, p, y, g, x) => {
      switch (f !== Ue && delete p.material[rt], f !== Ne && delete p.material[ot], f) {
        ...
        case Ks: {
          p.material.color.copy(xe(m.internal.depth)), delete p.material[rt], delete p.material[ot];
          break;
        }
      }
    };
...
//# sourceMappingURL=WMSCapabilitiesLoader-nJS67eJn.js.map
