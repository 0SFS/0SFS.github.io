...
import { F as EncodeArrayBufferToBase64, n as Tools } from "./tools-MFyJrFmb.js";
import { r as nativeOverride, v as __decorate } from "./decorators-DVeIBfCH.js";
import { n as EffectWrapper, t as EffectRenderer } from "./effectRenderer-B6L0iwtN.js";
...
async function _CreateDumpResourcesAsync() {
	...
	const { ThinEngine: thinEngineClass } = await import("./thinEngine-DOpRL7A8.js").then((n) => n.n);
	...
	const { passPixelShader } = await import("./pass.fragment-yifaY0Be.js").then((n) => n.n);
	return {
		canvas,
		dumpEngine: {
			engine,
...
//# sourceMappingURL=dumpTools-BfPNYznV.js.map