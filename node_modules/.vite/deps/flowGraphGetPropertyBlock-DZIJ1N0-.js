...
var flowGraphGetPropertyBlock_exports = /* @__PURE__ */ __exportAll({ FlowGraphGetPropertyBlock: () => FlowGraphGetPropertyBlock });
/**
...
var FlowGraphGetPropertyBlock = class extends FlowGraphCachedOperationBlock {
	...
	_doOperation(context) {
		...
		let value;
		if (getter) value = getter(this.object.getValue(context), this.propertyName.getValue(context), context);
		else {
...
//#endregion
export { flowGraphGetPropertyBlock_exports as n, FlowGraphGetPropertyBlock as t };

//# sourceMappingURL=flowGraphGetPropertyBlock-DZIJ1N0-.js.map