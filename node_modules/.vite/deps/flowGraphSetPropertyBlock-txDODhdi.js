...
var flowGraphSetPropertyBlock_exports = /* @__PURE__ */ __exportAll({ FlowGraphSetPropertyBlock: () => FlowGraphSetPropertyBlock });
/**
...
var FlowGraphSetPropertyBlock = class extends FlowGraphExecutionBlockWithOutSignal {
	...
	_execute(context, _callingSignal) {
		try {
			...
			if (setFunction) setFunction(target, propertyName, value, context);
			else this._setPropertyValue(target, propertyName, value);
		} catch (e) {
	...
	_stopRunningAnimations(context, target, propertyName) {
		...
		for (const uniqueId of currentlyRunningAnimationGroups) {
			...
			if (animationGroup) {
				for (const targetedAnimations of animationGroup.targetedAnimations) if (targetedAnimations.target === target && targetedAnimations.animation.targetProperty === propertyName) {
...
//#endregion
export { flowGraphSetPropertyBlock_exports as n, FlowGraphSetPropertyBlock as t };

//# sourceMappingURL=flowGraphSetPropertyBlock-txDODhdi.js.map