...
import { A as FlowGraphInteger, m as RichTypeFlowGraphInteger, v as RichTypeNumber } from "./flowGraphBlock-Rp1Fj8us.js";
import { t as FlowGraphAsyncExecutionBlock } from "./flowGraphAsyncExecutionBlock-Ci_ukyAF.js";
...
var flowGraphSetDelayBlock_exports = /* @__PURE__ */ __exportAll({ FlowGraphSetDelayBlock: () => FlowGraphSetDelayBlock });
/**
...
var FlowGraphSetDelayBlock = class FlowGraphSetDelayBlock extends FlowGraphAsyncExecutionBlock {
	...
	_updateGlobalTimers(context) {
		...
		for (let i = 0; i < timers.length; i++) {
			...
			if (globalTimers[i] && globalTimers[i] !== timer) Logger.Warn("FlowGraphTimerBlock: Timer ended but was not found in the running timers list");
			else globalTimers[i] = timer;
		}
...
//#endregion
export { setAndStartTimer as a, TimerState as i, flowGraphSetDelayBlock_exports as n, AdvancedTimer as r, FlowGraphSetDelayBlock as t };

//# sourceMappingURL=flowGraphSetDelayBlock-Dkmenmxo.js.map