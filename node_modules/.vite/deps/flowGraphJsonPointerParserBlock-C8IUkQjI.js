...
import { a as Vector3, o as Vector4 } from "./math.vector-DlKiwPhs.js";
import { r as RegisterClass } from "./typeStore-Dy-yCYbL.js";
import { n as Color4, t as Color3 } from "./math.color-DD4nIbaE.js";
import { A as FlowGraphInteger, m as RichTypeFlowGraphInteger, u as RichTypeAny } from "./flowGraphBlock-Rp1Fj8us.js";
...
var flowGraphJsonPointerParserBlock_exports = /* @__PURE__ */ __exportAll({ FlowGraphJsonPointerParserBlock: () => FlowGraphJsonPointerParserBlock });
/**
...
var FlowGraphJsonPointerParserBlock = class extends FlowGraphCachedOperationBlock {
	...
	_getPropertyValue(_target, _propertyName, context) {
		...
		const type = accessorContainer.info.type;
		const value = accessorContainer.info.get(accessorContainer.object);
		if (type.startsWith("Color")) return FromColor(value);
		return value;
	}
...
function FromColor(value) {
	if (value instanceof Color3) return new Vector3(value.r, value.g, value.b);
	else if (value instanceof Color4) return new Vector4(value.r, value.g, value.b, value.a);
	throw new Error("Invalid color type");
}
RegisterClass("FlowGraphJsonPointerParserBlock", FlowGraphJsonPointerParserBlock);
//#endregion
export { flowGraphJsonPointerParserBlock_exports as n, FlowGraphPathConverterComponent as r, FlowGraphJsonPointerParserBlock as t };

//# sourceMappingURL=flowGraphJsonPointerParserBlock-C8IUkQjI.js.map