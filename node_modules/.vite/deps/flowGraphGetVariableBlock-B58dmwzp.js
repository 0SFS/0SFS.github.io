...
var flowGraphGetVariableBlock_exports = /* @__PURE__ */ __exportAll({ FlowGraphGetVariableBlock: () => FlowGraphGetVariableBlock });
/**
...
var FlowGraphGetVariableBlock = class extends FlowGraphBlock {
	...
	*/
	_updateOutputs(context) {
		...
		if (context.hasVariable(variableNameValue)) this.value.setValue(context.getVariable(variableNameValue), context);
	}
	/**
...
//#endregion
export { flowGraphGetVariableBlock_exports as n, FlowGraphGetVariableBlock as t };

//# sourceMappingURL=flowGraphGetVariableBlock-B58dmwzp.js.map