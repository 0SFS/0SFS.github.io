...
import "./harmonicsFunctions-DdF1181-.js";
...
var name$30 = "clipPlaneFragmentDeclaration";
var shader$30 = `#ifdef CLIPPLANE
...
var name$29 = "fogFragmentDeclaration";
var shader$29 = `#ifdef FOG
...
var name$28 = "logDepthFragment";
var shader$28 = `#ifdef LOGARITHMICDEPTH
...
var name$27 = "fogFragment";
var shader$27 = `#ifdef FOG
...
var name$26 = "clipPlaneFragment";
var shader$26 = `#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
var name$25 = "clusteredLightingFunctions";
var shader$25 = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
...
var name$24 = "reflectionFunction";
var shader$24 = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
var name$23 = "imageProcessingDeclaration";
var shader$23 = `#ifdef EXPOSURE
...
var name$22 = "lightUboDeclaration";
var shader$22 = `#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
...
var name$21 = "ltcHelperFunctions";
var shader$21 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var name$20 = "shadowsFragmentFunctions";
var shader$20 = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
var name$19 = "imageProcessingFunctions";
var shader$19 = `#if TONEMAPPING==3
...
var name$18 = "prePassDeclaration";
var shader$18 = `#ifdef PREPASS
...
var name$17 = "oitDeclaration";
var shader$17 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var name$16 = "pbrFragmentExtraDeclaration";
var shader$16 = `varying vPositionW: vec3f;
#if DEBUGMODE>0
...
var name$15 = "samplerFragmentDeclaration";
var shader$15 = `#ifdef _DEFINENAME_
...
var name$14 = "subSurfaceScatteringFunctions";
var shader$14 = `fn testLightingForSSS(diffusionProfile: f32)->bool
...
var name$13 = "importanceSampling";
var shader$13 = `fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var name$12 = "pbrHelperFunctions";
var shader$12 = `#define MINIMUMVARIANCE 0.0005
...
var name$11 = "pbrDirectLightingSetupFunctions";
var shader$11 = `struct preLightingInfo
{lightOffset: vec3f,
...
var name$10 = "pbrDirectLightingFalloffFunctions";
var shader$10 = `fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
var name$9 = "hdrFilteringFunctions";
var shader$9 = `#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
var name$8 = "pbrBlockReflectance0";
var shader$8 = `var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
var name$7 = "pbrDirectLightingFunctions";
var shader$7 = `#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
var name$6 = "pbrIBLFunctions";
var shader$6 = `#if defined(REFLECTION) || defined(SS_REFRACTION)
...
var name$5 = "pbrBlockNormalGeometric";
var shader$5 = `var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
var shader$2 = `#if SCENE_MRT_COUNT>0
...
//#endregion
export { lightUboDeclarationWGSL as a, imageProcessingDeclaration_exports as c, clipPlaneFragmentWGSL as d, clipPlaneFragment_exports as f, clipPlaneFragmentDeclaration_exports as g, clipPlaneFragmentDeclarationWGSL as h, shadowsFragmentFunctions_exports as i, reflectionFunctionWGSL as l, fogFragmentDeclaration_exports as m, imageProcessingFunctions_exports as n, lightUboDeclaration_exports as o, fogFragmentDeclarationWGSL as p, shadowsFragmentFunctionsWGSL as r, imageProcessingDeclarationWGSL as s, imageProcessingFunctionsWGSL as t, reflectionFunction_exports as u };

//# sourceMappingURL=pbrDebug-CYe1WAHu.js.map