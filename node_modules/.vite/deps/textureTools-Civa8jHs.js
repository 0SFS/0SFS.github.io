...
import { a as Vector3, i as Vector2, r as TmpVectors, t as Matrix, y as _ObserveArray } from "./math.vector-DlKiwPhs.js";
import { r as RegisterClass, t as GetClass } from "./typeStore-Dy-yCYbL.js";
import { t as EngineStore } from "./engineStore-Cs1hlddx.js";
import { t as Clamp } from "./math.scalar.functions-SG45_xnw.js";
import "./math.color-DD4nIbaE.js";
import { t as Logger } from "./logger-DkPtg8o-.js";
import { i as serialize, s as serializeAsColor4, v as __decorate } from "./decorators-DVeIBfCH.js";
import { n as SerializationHelper } from "./math.size-qIcKZf_0.js";
import { i as IsDocumentAvailable, o as IsWindowObjectExist, t as PrecisionDate } from "./precisionDate-DBafd2VO.js";
import { A as _RetryWithInterval, B as allocateAndCopyTypedBuffer, a as NearestPOT, c as InternalTexture, h as Effect, n as GetExponentOfTwo, o as AbstractEngine, r as IsExponentOfTwo, t as FloorPOT } from "./tools.functions-DiTKq2Ft.js";
import { a as PostProcessManager, o as SmartArray, r as RenderingManager } from "./math.frustum-C6NSShNa.js";
import { t as UniformBuffer } from "./uniformBuffer-CaXicCmS.js";
import { t as PerfCounter } from "./perfCounter-DmGb1ePC.js";
import "./math.plane-6siTpm0u.js";
import { t as LightConstants } from "./lightConstants-C7G9Rkm_.js";
import "./math.path-CICXlhVS.js";
import { n as EffectWrapper } from "./effectRenderer-B6L0iwtN.js";
import "./math.axis-BZSPa49y.js";
import { o as BaseTexture, t as Texture } from "./texture-D9B7zedU.js";
import { i as HasStencilAspect, o as WebGLHardwareTexture, s as WebGLDataBuffer, t as ThinEngine } from "./thinEngine-DOpRL7A8.js";
	...
	*/
	isReadyForRendering() {
		if (!this._dumpToolsLoading) {
			...
			import("./dumpTools-BfPNYznV.js").then((n) => n.a).then((module) => this._dumpTools = module);
		}
...
var PostProcess = class PostProcess {
	...
	*/
	...
	_gatherImports(useWebGPU = false, list) {
		if (useWebGPU && this._webGPUReady) list.push(Promise.all([import("./postprocess.vertex--SnPz2DP.js").then((n) => n.n)]));
		else list.push(Promise.all([import("./postprocess.vertex-BREcB19_.js").then((n) => n.n)]));
	}
	/**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
	const callbackAsync = async (loadData) => {
		...
		if (!width) return;
		const { DDSTools } = await import("./dds-DEFXwYrL.js").then((n) => n.n);
		const textures = [];
...
function _GetCompatibleTextureLoader(extension, mimeType) {
	...
	if (!RegisteredTextureLoaders.has(extension)) {
		if (extension.endsWith(".ies")) registerTextureLoader(".ies", async () => await import("./iesTextureLoader-CdQswfuz.js").then((n) => n.n).then((module) => new module._IESTextureLoader()));
		if (extension.endsWith(".dds")) registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-Fyjvj5vH.js").then((n) => n.n).then((module) => new module._DDSTextureLoader()));
		if (extension.endsWith(".basis")) registerTextureLoader(".basis", async () => await import("./basisTextureLoader-Oy24FCP0.js").then((n) => n.n).then((module) => new module._BasisTextureLoader()));
		if (extension.endsWith(".env")) registerTextureLoader(".env", async () => await import("./envTextureLoader-DjMu0Zfu.js").then((n) => n.n).then((module) => new module._ENVTextureLoader()));
		if (extension.endsWith(".hdr")) registerTextureLoader(".hdr", async () => await import("./hdrTextureLoader-DN2-k8WW.js").then((n) => n.n).then((module) => new module._HDRTextureLoader()));
		if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
			registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-Czjs4SEg.js").then((n) => n.n).then((module) => new module._KTXTextureLoader()));
			registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-Czjs4SEg.js").then((n) => n.n).then((module) => new module._KTXTextureLoader()));
		}
		if (extension.endsWith(".tga")) registerTextureLoader(".tga", async () => await import("./tgaTextureLoader-C0jT-YKF.js").then((n) => n.n).then((module) => new module._TGATextureLoader()));
		if (extension.endsWith(".exr")) registerTextureLoader(".exr", async () => await import("./exrTextureLoader-DObdaIau.js").then((n) => n.r).then((module) => new module._ExrTextureLoader()));
	}
...
var ThinPassPostProcess = class ThinPassPostProcess extends EffectWrapper {
	_gatherImports(useWebGPU, list) {
		if (useWebGPU) {
			...
			list.push(Promise.all([import("./pass.fragment-CrJiGBx6.js").then((n) => n.n)]));
		} else list.push(Promise.all([import("./pass.fragment-yifaY0Be.js").then((n) => n.n)]));
...
var ThinPassCubePostProcess = class ThinPassCubePostProcess extends EffectWrapper {
	_gatherImports(useWebGPU, list) {
		if (useWebGPU) {
			this._webGPUReady = true;
			list.push(Promise.all([import("./passCube.fragment-CijrNlbL.js").then((n) => n.n)]));
		} else list.push(Promise.all([import("./passCube.fragment-C4Zj5Tev.js").then((n) => n.n)]));
		super._gatherImports(useWebGPU, list);
	}
	/**
...
async function ReadPixelsUsingRTT(texture, width, height, face, lod) {
	const scene = texture.getScene();
	const engine = scene.getEngine();
	if (!engine.isWebGPU) if (texture.isCube) await import("./lodCube.fragment-Be5DzsrL.js").then((n) => n.n);
	else await import("./lod.fragment-CQSXlzYf.js").then((n) => n.n);
	else if (texture.isCube) await import("./lodCube.fragment-Dv3YcwRO.js").then((n) => n.n);
	else await import("./lod.fragment--4KCOqBk.js").then((n) => n.n);
	let lodPostProcess;
...
async function GetTextureDataAsync(texture, width, height, face = 0, lod = 0, forceRTT = false) {
	...
	if (forceRTT || IsCompressedTextureFormat(texture.textureFormat) || targetWidth !== textureWidth || targetHeight !== textureHeight) {
		if (texture.is2DArray || texture.is3D) throw new Error(`Reading pixels from 2D array or 3D textures with ${forceRTT ? "RTT" : "compression"} is not supported.`);
