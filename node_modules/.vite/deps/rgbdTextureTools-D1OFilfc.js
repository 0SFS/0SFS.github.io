import { M as PostProcess, t as ApplyPostProcess } from "./textureTools-Civa8jHs.js";
...
var RGBDTextureTools = class {
	...
	*/
	static ExpandRGBDTexture(texture) {
		...
		const expandRgbdTextureAsync = async () => {
			...
			internalTexture.isReady = false;
			if (isWebGpu) await import("./rgbdDecode.fragment-BNiiWMf5.js").then((n) => n.n);
			else await import("./rgbdDecode.fragment-CucvhgsW.js").then((n) => n.n);
	...
	*/
	static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
		if (!scene.getEngine().isWebGPU) await import("./rgbdEncode.fragment-CmwNp43j.js").then((n) => n.n);
		else await import("./rgbdEncode.fragment-DzqnAaKy.js").then((n) => n.n);
...
//# sourceMappingURL=rgbdTextureTools-D1OFilfc.js.map