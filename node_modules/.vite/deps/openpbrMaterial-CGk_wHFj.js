...
import { i as Vector2, o as Vector4, r as TmpVectors } from "./math.vector-DlKiwPhs.js";
import { r as RegisterClass } from "./typeStore-Dy-yCYbL.js";
import { t as Color3 } from "./math.color-DD4nIbaE.js";
import { t as Logger } from "./logger-DkPtg8o-.js";
import { n as Tools } from "./tools-MFyJrFmb.js";
import { $ as GetEnvironmentFuzzBRDFTexture, Br as PrepareDefinesForMultiview, Cr as PrepareAttributesForBakedVertexAnimation, Er as PrepareAttributesForMorphTargets, Hr as PrepareDefinesForPrePass, Ir as PrepareDefinesForLights, Jr as BindLogDepth, Kr as PrepareUniformsAndSamplersList, Kt as MaterialHelperGeometryRendering, Lr as PrepareDefinesForMergedUV, Nr as PrepareDefinesForFrameBoundValues, Pr as PrepareDefinesForIBL, Q as GetEnvironmentBRDFTexture, Rr as PrepareDefinesForMisc, Sr as HandleFallbacksForShadows, Tr as PrepareAttributesForInstances, Ur as PrepareUniformLayoutForIBL, Ut as ImageProcessingMixin, Vr as PrepareDefinesForOIT, Wr as PrepareUniformsAndSamplersForIBL, Wt as UVDefinesMixin, Xr as AddClipPlaneUniforms, Yr as MaterialFlags, Zr as BindClipPlane, _r as BindLights, br as BindTextureMatrix, dr as BindBonesParameters, fr as BindFogParameters, hn as EffectFallbacks, kr as PrepareDefinesForAttributes, mn as PushMaterial, mr as BindIBLSamplers, nn as MaterialDefines, pr as BindIBLParameters, rn as PrePassConfiguration, tn as ImageProcessingDefinesMixin, ur as Material, vr as BindMorphTargetParameters, wr as PrepareAttributesForBones } from "./lazy-Bb8psdId.js";
import { i as serialize, n as expandToProperty, t as addAccessorsForMaterialProperty, v as __decorate } from "./decorators-DVeIBfCH.js";
import { n as SerializationHelper } from "./math.size-qIcKZf_0.js";
import { o as SmartArray } from "./math.frustum-C6NSShNa.js";
import { t as ImageProcessingConfiguration } from "./imageProcessingConfiguration-ZO-7NPI2.js";
import { n as VertexBuffer } from "./buffer-D-vd3sYH.js";
import { t as Texture } from "./texture-D9B7zedU.js";
...
var OpenPBRMaterial = class OpenPBRMaterial extends OpenPBRMaterialBase {
		...
		if (mustRebind) {
			...
			if (!ubo.useUbo || !this.isFrozen || !ubo.isSync || subMesh._drawWrapper._forceRebindOnNextCall) {
				if (scene.texturesEnabled) {
					...
					if (this.geometryNormalTexture) if (scene._mirroredCameraPosition) ubo.updateFloat2("vTangentSpaceParams", this._invertNormalMapX ? 1 : -1, this._invertNormalMapY ? 1 : -1);
				...
				Object.values(this._uniformsList).forEach((uniform) => {
					...
					} else if (uniform.numComponents === 1) ubo.updateFloat(uniform.name, uniform.linkedProperties[Object.keys(uniform.linkedProperties)[0]].value);
				});
			...
			if (scene.texturesEnabled) {
				...
				if (defines.ANISOTROPIC || defines.FUZZ || defines.REFRACTED_BACKGROUND) ubo.setTexture("blueNoiseSampler", OpenPBRMaterial._noiseTextures[this.getScene().uniqueId]);
			}
	...
	*/
	dispose(forceDisposeEffect, forceDisposeTextures) {
		...
		if (forceDisposeTextures) {
			if (this._environmentBRDFTexture && this.getScene().environmentBRDFTexture !== this._environmentBRDFTexture) this._environmentBRDFTexture.dispose();
	...
	*/
	...
	_prepareEffect(mesh, renderingMesh, defines, onCompiled = null, onError = null, useInstances = null, useClipPlane = null) {
		...
		if (defines.ANISOTROPIC || defines.FUZZ || defines.REFRACTED_BACKGROUND) samplers.push("blueNoiseSampler");
		for (const key in this._samplersList) {
			const sampler = this._samplersList[key];
		...
		const effect = engine.createEffect(shaderName, {
			...
			extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
				if (this.shaderLanguage === 1) await Promise.all([import("./openpbr.vertex-qq6MtZuM.js").then((n) => n.n), import("./openpbr.fragment-M2MvhA1B.js").then((n) => n.n)]);
				else await Promise.all([import("./openpbr.vertex-CYVKeh6S.js").then((n) => n.n), import("./openpbr.fragment-DByrbXtk.js").then((n) => n.n)]);
...
//#endregion
export { OpenPBRMaterialDefines as n, openpbrMaterial_exports as r, OpenPBRMaterial as t };

//# sourceMappingURL=openpbrMaterial-CGk_wHFj.js.map