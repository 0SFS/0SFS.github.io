...
import "./harmonicsFunctions-B7zy_QfM.js";
...
var name$25 = "reflectionFunction";
var shader$25 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
var name$24 = "imageProcessingDeclaration";
var shader$24 = `#ifdef EXPOSURE
...
var name$23 = "lightFragmentDeclaration";
var shader$23 = `#ifdef LIGHT{X}
...
var shader$21 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var shader$19 = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
var name$16 = "decalFragmentDeclaration";
var shader$16 = `#ifdef DECAL
...
var name$15 = "pbrFragmentExtraDeclaration";
var shader$15 = `varying vec3 vPositionW;
#if DEBUGMODE>0
...
var name$13 = "subSurfaceScatteringFunctions";
var shader$13 = `bool testLightingForSSS(float diffusionProfile)
...
var name$12 = "importanceSampling";
var shader$12 = `vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var name$11 = "pbrHelperFunctions";
var shader$11 = `#define MINIMUMVARIANCE 0.0005
...
var name$10 = "pbrDirectLightingSetupFunctions";
var shader$10 = `struct preLightingInfo
...
var name$8 = "hdrFilteringFunctions";
var shader$8 = `#if NUM_SAMPLES
#if NUM_SAMPLES>0
#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
var shader$5 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
//#endregion
export { clipPlaneFragmentDeclaration as _, lightUboDeclaration as a, lightFragmentDeclaration_exports as c, reflectionFunction as d, reflectionFunction_exports as f, fogFragmentDeclaration_exports as g, fogFragmentDeclaration as h, shadowsFragmentFunctions_exports as i, imageProcessingDeclaration as l, clipPlaneFragment_exports as m, imageProcessingFunctions_exports as n, lightUboDeclaration_exports as o, clipPlaneFragment as p, shadowsFragmentFunctions as r, lightFragmentDeclaration as s, imageProcessingFunctions as t, imageProcessingDeclaration_exports as u, clipPlaneFragmentDeclaration_exports as v };

//# sourceMappingURL=pbrDebug-DbDN-9_h.js.map