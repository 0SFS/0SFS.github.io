import{R as e}from"./index-C-Y6kbze.js";import{t}from"./shaderStore-DSzASZqB.js";import"./clipPlaneVertex-C-3ulsnq.js";import"./clipPlaneVertexDeclaration-DNaFCL4_.js";import"./helperFunctions-CcdcZpUX.js";import"./sceneUboDeclaration-CldpS112.js";import"./logDepthDeclaration-pX0SKwcK.js";import"./fogVertexDeclaration-KPTLcNXg.js";import"./fogVertex-BOtcyq3L.js";import"./logDepthVertex-BWJfC1Rj.js";import"./meshUboDeclaration-cBHPcoQ-.js";var n=`gaussianSplattingVertexDeclaration`,r=`attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`;t.IncludesShadersStore[n]||(t.IncludesShadersStore[n]=r);var i=`gaussianSplattingUboDeclaration`,a=`#include<sceneUboDeclaration>
...
`;t.IncludesShadersStore[i]||(t.IncludesShadersStore[i]=a);var o=`gaussianSplatting`,s=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`;t.IncludesShadersStore[o]||(t.IncludesShadersStore[o]=s);var c=e({gaussianSplattingVertexShader:()=>d}),l=`gaussianSplattingVertexShader`,u=`#include<__decl__gaussianSplattingVertex>
