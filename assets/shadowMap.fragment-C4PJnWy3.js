import{K as e}from"./index-D-4xi28n.js";import{t}from"./shaderStore-DSzASZqB.js";import"./clipPlaneFragment-BdxklcFO.js";import"./clipPlaneFragmentDeclaration-Bix7HatJ.js";import"./packingFunctions-BDktjcFh.js";import"./shadowMapFragment-CDVcSooN.js";var n=`bayerDitherFunctions`,r=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;t.IncludesShadersStoreWGSL[n]||(t.IncludesShadersStoreWGSL[n]=r);var i=`shadowMapFragmentExtraDeclaration`,a=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;t.IncludesShadersStoreWGSL[i]||(t.IncludesShadersStoreWGSL[i]=a);var o=e({shadowMapPixelShaderWGSL:()=>l}),s=`shadowMapPixelShader`,c=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
