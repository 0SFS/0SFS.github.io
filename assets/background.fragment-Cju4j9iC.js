import{R as e}from"./index-C-Y6kbze.js";import{t}from"./shaderStore-DSzASZqB.js";import"./clipPlaneFragment-qahx9zAh.js";import"./clipPlaneFragmentDeclaration-DRX97gD6.js";import"./fogFragmentDeclaration-BtVlbU1P.js";import"./helperFunctions-CcdcZpUX.js";import"./imageProcessingDeclaration-NuVefH2X.js";import"./imageProcessingFunctions-D0we1YH-.js";import"./lightFragment-DYYi1ddE.js";import"./lightFragmentDeclaration-AEsc9nsZ.js";import"./lightUboDeclaration-BUqH8PhY.js";import"./lightsFragmentFunctions-CLDH8Us_.js";import"./reflectionFunction-Cdzw98xy.js";import"./shadowsFragmentFunctions-BRdiv7zM.js";import"./backgroundUboDeclaration-6dK3kU7G.js";import"./logDepthDeclaration-pX0SKwcK.js";import"./logDepthFragment-CjeWn_xY.js";import"./fogFragment-BiROhISf.js";var n=`backgroundFragmentDeclaration`,r=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
#endif
`;t.IncludesShadersStore[n]||(t.IncludesShadersStore[n]=r);var i=`intersectionFunctions`,a=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;t.IncludesShadersStore[i]||(t.IncludesShadersStore[i]=a);var o=e({backgroundPixelShader:()=>l}),s=`backgroundPixelShader`,c=`#ifdef TEXTURELODSUPPORT
