import{K as e}from"./index-fa2H_vXh.js";import{t}from"./shaderStore-DSzASZqB.js";import"./helperFunctions-Bgb59QTu.js";import"./meshUboDeclaration-pqASoc0l.js";import"./sceneUboDeclaration-C6zEgy7a.js";import"./clipPlaneVertex-zgqN1ax1.js";import"./clipPlaneVertexDeclaration-Dow4rtY_.js";import"./logDepthDeclaration-CpoI9b8K.js";import"./fogVertexDeclaration-DodqqZJc.js";import"./fogVertex-DwTHL8Li.js";import"./logDepthVertex-Bpf4mIw3.js";var n=`gaussianSplatting`,r=`fn getDataUV(index: f32,dataTextureSize: vec2f)->vec2<f32> {let y: f32=floor(index/dataTextureSize.x);let x: f32=index-y*dataTextureSize.x;return vec2f((x+0.5),(y+0.5));}
...
#endif
`;t.IncludesShadersStoreWGSL[n]||(t.IncludesShadersStoreWGSL[n]=r);var i=e({gaussianSplattingVertexShaderWGSL:()=>s}),a=`gaussianSplattingVertexShader`,o=`#include<sceneUboDeclaration>
